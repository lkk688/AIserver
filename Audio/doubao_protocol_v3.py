...
async def receive_message(websocket: WebSocketClientProtocol) -> Message:
...
async def full_client_request(
    websocket: WebSocketClientProtocol, payload: bytes
) -> None:
...
async def audio_only_client(
    websocket: WebSocketClientProtocol, payload: bytes, flag: MsgTypeFlagBits
) -> None:
...
async def start_connection(websocket: WebSocketClientProtocol) -> None:
    """Start connection"""
...
async def finish_connection(websocket: WebSocketClientProtocol) -> None:
    """Finish connection"""
    msg = Message(type=MsgType.FullClientRequest, flag=MsgTypeFlagBits.WithEvent)
...
async def start_session(
    websocket: WebSocketClientProtocol, payload: bytes, session_id: str
) -> None:
    """Start session"""
    msg = Message(type=MsgType.FullClientRequest, flag=MsgTypeFlagBits.WithEvent)
...
async def finish_session(
    websocket: WebSocketClientProtocol, session_id: str
) -> None:
    """Finish session"""
    msg = Message(type=MsgType.FullClientRequest, flag=MsgTypeFlagBits.WithEvent)
